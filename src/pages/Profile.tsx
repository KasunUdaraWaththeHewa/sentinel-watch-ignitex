...
const Profile = () => {
  ...
  const activeItems = mockWatchedItems.filter(
        ...
        <div className="space-y-3">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="h-11 border-sentinel-border bg-transparent text-foreground rounded-xl focus:ring-1 focus:ring-sentinel-accent-cyan/40"
            />
          </div>
          <div className="space-y-1.5">
            <label className="text-[10px] text-muted-foreground uppercase tracking-widest font-medium">
            ...
            <Input
              value={email}
              disabled
              className="h-11 border-sentinel-border bg-transparent text-muted-foreground opacity-60 rounded-xl"
            />
          </div>
        </div>
        <Button variant="glass-primary" size="sm" className="rounded-xl">
          Save Changes
        </Button>
      </motion.div>
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Sign out of your Sentinel account
            </p>
          </div>
          <Button
            variant="glass"
            size="sm"
            className="gap-2 text-sentinel-severity-high border-sentinel-severity-high/20 hover:bg-sentinel-severity-high/5 rounded-xl"
          >
