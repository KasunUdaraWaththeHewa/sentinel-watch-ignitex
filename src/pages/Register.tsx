      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <label className="flex items-start gap-2.5 text-sm text-muted-foreground cursor-pointer select-none px-1">
            <input
              type="checkbox"
              className="rounded border-sentinel-border accent-sentinel-accent-cyan mt-0.5"
              required
            />
            <span>
              I agree to the{" "}
              <a href="#" className="text-sentinel-accent-cyan hover:underline">
                Terms of Service
              </a>{" "}
              and{" "}
              <a href="#" className="text-sentinel-accent-cyan hover:underline">
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <Link
            to="/login"
            className="text-sentinel-accent-cyan hover:underline font-medium"
          >
            Sign in
          </Link>
        </p>
