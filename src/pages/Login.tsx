...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background bg-noise flex items-center justify-center px-4 py-12">
      {/* Ambient glow */}
      <div className="fixed top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[300px] rounded-full bg-sentinel-accent-cyan/5 blur-[150px] pointer-events-none" />
      ...
      >
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            <h1 className="text-2xl font-display font-semibold text-foreground tracking-tight">Welcome back</h1>
            <p className="text-sm text-muted-foreground mt-1">Sign in to your Sentinel account</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="glass-surface rounded-2xl p-5 space-y-3">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 h-12 border-sentinel-border bg-transparent text-foreground placeholder:text-muted-foreground rounded-xl focus:ring-1 focus:ring-sentinel-accent-cyan/40"
                required
              />
              <button
                type="button"
          ...
          <div className="flex items-center justify-between px-1">
            <label className="flex items-center gap-2 text-sm text-muted-foreground cursor-pointer select-none">
              <input type="checkbox" className="rounded border-sentinel-border accent-sentinel-accent-cyan" />
              Remember me
            </label>
            <Link to="/forgot-password" className="text-sm text-sentinel-accent-cyan hover:underline">
              Forgot password?
            </Link>
          </div>
        ...
        <div className="relative">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-sentinel-border" />
          </div>
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <Link to="/register" className="text-sentinel-accent-cyan hover:underline font-medium">Create one</Link>
        </p>
      </motion.div>
    </div>
  );
