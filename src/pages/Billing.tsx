        ...
        <div className="glass-surface rounded-full p-1 flex gap-1">
          <button
            ...
            className={cn(
              ...
              cycle === "monthly" ? "bg-sentinel-accent-cyan/15 text-foreground" : "text-muted-foreground hover:text-foreground"
            )}
          >
            Monthly
          </button>
          <button
            ...
            className={cn(
              ...
              cycle === "yearly" ? "bg-sentinel-accent-cyan/15 text-foreground" : "text-muted-foreground hover:text-foreground"
            )}
          >
            Yearly
          ...
          >
            ...
            <div className="mb-6">
              ...
              {cycle === "yearly" && plan.yearly > 0 && (
                <p className="text-xs text-muted-foreground mt-1">${plan.yearly}/year billed annually</p>
              )}
            </div>
            ...
            <Button variant={plan.popular ? "glass-primary" : "glass"} className="w-full" disabled={plan.id === "free"}>
              {plan.cta}
            </Button>
          </motion.div>
        ))}
