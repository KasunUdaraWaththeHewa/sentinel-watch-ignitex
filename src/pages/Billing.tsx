  ...
  return (
    ...
    >
        ...
        {BILLING_PLANS.map((plan, i) => (
          <motion.div
            ...
            className={cn(
              ...
              plan.popular &&
                "ring-1 ring-sentinel-accent-cyan/30 sentinel-glow",
            )}
          >
            {plan.popular && (
      ...
      <motion.p
        ...
        className="text-center text-xs text-muted-foreground max-w-sm mx-auto"
      >
    ...
    >
      {active && (
        <motion.div
          ...
          className="absolute inset-0 bg-sentinel-accent-cyan/10 rounded-full"
          transition={{ type: "spring", bounce: 0.2, duration: 0.5 }}
        />
      )}
      <span className="relative">{label}</span>
      {badge && (
        <span className="relative text-[10px] bg-sentinel-accent-cyan/20 text-sentinel-accent-cyan px-1.5 py-0.5 rounded-full">
          {badge}
        </span>
      )}
    </button>
