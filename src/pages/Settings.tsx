...
const Settings = () => {
  ...
  return (
    <div className="min-h-screen bg-background bg-noise">
      <TopNav />
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-8 pb-28 md:pb-12 space-y-8">
        <motion.div
        ...
        >
          ...
          <p className="text-sm text-muted-foreground">
            Configure how Sentinel works for you.
          </p>
        </motion.div>
        ...
        <SettingsSection title="Quiet Hours" icon={<Clock className="h-4 w-4" />} delay={0.1}>
          <div className="space-y-4">
            <SettingsRow
              ...
              icon={<Moon className="h-4 w-4 text-sentinel-accent-cyan" />}
            >
            ...
            {quietHoursEnabled && (
              <div className="flex items-center gap-3 pl-10">
                <input
                  ...
                  className="glass-surface border-sentinel-border bg-transparent text-foreground text-sm rounded-lg px-3 py-2"
                />
        ...
        <SettingsSection title="Timezone" icon={<Globe className="h-4 w-4" />} delay={0.15}>
          <select
            ...
            className="w-full glass-surface border-sentinel-border bg-transparent text-foreground text-sm rounded-lg px-3 py-3 appearance-none cursor-pointer"
          >
            {timezones.map((tz) => (
