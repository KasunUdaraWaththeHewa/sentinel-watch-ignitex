      ...
      <section className="relative py-20 sm:py-28 lg:py-36 px-4">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.9, ease: SENTINEL_EASE }}
            className="space-y-8"
          >
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                {[
                  { label: "Watching", value: "8", color: "text-foreground" },
                  {
                    label: "Urgent",
                    value: "2",
                    color: "text-sentinel-severity-high",
                  },
                  { label: "This Week", value: "3", color: "text-foreground" },
                ].map((s) => (
                  <div
                    key={s.label}
                    className="glass-surface rounded-lg p-2.5 sm:p-3 text-center"
                  >
                    <p
                      className={`text-lg sm:text-xl font-display font-bold ${s.color}`}
                    >
                      {s.value}
                    </p>
      ...
      <section id="features" className="px-4 py-16 sm:py-24">
        <div className="max-w-6xl mx-auto">
          <motion.div {...FADE_UP} className="text-center mb-12 sm:mb-16">
            <p className="text-xs font-medium uppercase tracking-widest text-sentinel-accent-cyan mb-3">
              Features
            </p>
            ...
            <p className="text-muted-foreground mt-4 max-w-xl mx-auto text-base sm:text-lg">
              Every feature is designed around one goal: make sure you never
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-5">
            {LANDING_FEATURES.map((feature, i) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center transition-transform duration-500 group-hover:scale-110`}
                >
                ...
                >
                  <div className="glass-surface rounded-2xl p-6 sm:p-8 space-y-4 h-full">
                    <div className="flex items-center gap-3">
                      <span className="text-3xl sm:text-4xl font-display font-bold text-sentinel-accent-cyan/20">
                        {step.step}
                      </span>
          ...
          <div className="glass-surface rounded-2xl sm:rounded-3xl p-8 sm:p-12 lg:p-16 text-center space-y-6 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-muted-foreground max-w-lg mx-auto text-base sm:text-lg">
                Join thousands who've offloaded their mental load to Sentinel.
