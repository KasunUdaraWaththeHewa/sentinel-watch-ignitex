        ...
        {showAdd && (
          ...
          >
            <div className="glass-surface rounded-2xl p-5 sm:p-6 space-y-4">
              <h3 className="font-display font-semibold text-sm text-foreground uppercase tracking-widest">
                Create Category
              </h3>
              <Input
              ...
              <div className="space-y-2">
                <label className="text-[10px] text-muted-foreground uppercase tracking-widest font-medium flex items-center gap-1.5">
              ...
              <Button
                ...
                className="bg-sentinel-accent-cyan text-background hover:opacity-90 rounded-xl"
                size="sm"
              >
                Create Category
              </Button>
            ...
            >
              {!isDefaultCat && (
                <button
                  ...
                  className="absolute top-3 right-3 w-7 h-7 rounded-full bg-destructive/10 text-destructive flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200 hover:scale-110"
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {(() => {
                    ...
                    return (
                      <p className="text-sm text-muted-foreground">
                        No watched items in this category. It can be safely
                        removed.
                      </p>
                    );
                  })()}
