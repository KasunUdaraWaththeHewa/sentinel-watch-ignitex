...
export function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-xl bg-background/70 border-b border-sentinel-border">
      <div className="max-w-5xl mx-auto flex items-center justify-between h-14 sm:h-16 px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden md:flex items-center gap-0.5">
          ...
          <Link
            to="/profile"
            className={cn(
              "relative ml-2 w-9 h-9 rounded-full flex items-center justify-center transition-colors duration-200",
